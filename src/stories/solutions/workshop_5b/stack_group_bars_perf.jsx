...
export default class StackGroupBarsPerf extends React.Component<Props> {
  ...
  get preResizeDimensions(): PreResizeDimensions {
    return { height: this.preResizeHeight, width: this.preResizeWidth };
  }
...
class StackGroupBarsD3 {
  ...
  updateSelectionTransform = (
    ...
    selection.attr(
      'transform',
      `translate(${xStart + props.marginLeft}, ${props.marginTop +
      yStart}) scale(${xZoom}, ${yZoom})`
    );
  };
...
function computeResizeTransforms(
  ...
  return { xStart: 0, xZoom, yStart: 0, yZoom };
}
